...
<body>
  ...
  <div class="form">
    <form method="post" action="made.php" id="register">
        ...
        <label for ="legal-rights" id="legal"><a href="register.php"> By signing up, you agree to our Terms & Privacy Policy.</a></label>
      </fieldset>
    </form>
    <div class="legal">
      <p class="rights">
